...
\end{figure}
  ...
  \begin{center}
    ...
    % flower3.png: 604x788 pixel, 96dpi, 15.98x20.85 cm, bb=0 0 453 591
  \end{center}
  ...
  La deuxième propriété est assez triviale, puisque lorsqu'on prend un contour $m$ :

...
% TODO: parler de la limitation 'programme sans boucles'
...
pire-cas}\\[0.4cm] \HRule \\[1cm]
  ...
  Le but de mon étude est donc de détecter ces chemins infaisables et de transmettre cette information à l'outil avant qu'il démarre son analyse pour l'estimation du WCET.

  
  \subsection{Langages supportés}
  sur la figure\ref{abstraction architecture}, ...
  \begin{figure}
    \begin{center}

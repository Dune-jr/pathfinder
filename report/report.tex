...
%HUG: "on redémarre sans trop chercher à comprendre" forme un peu trop familière.
...
%HUG: tu peux ajouter que le passage des paramètres et de valeur de retour n'est pas explicite: utilisation d'un mix de registres et de valeurs empilées.
...
%HUG: des assembleurs sas boucle ? Tu es sûr ?
...
%HUG: pourquoi utilise un solveur SMT ? Problème d'ordre dans les paragraphes.
...
%HUG: ce n'est pas forcément un arbre (en tout cas à la base ?).
...
%HUG: pourquoi donne un exemple qui montre qu'il faut supprimer tous les prédicats contenant d!
...
%HUG: pourquoi ci-dessous il y a toujours 2 cas, d = a et d != a ? Donne également un également et ça motivera l'utilisation du update.
...
%HUG: fini ton paragraphe : et on fait donc le choix d'invalider.
...
%HUG: elle cherche seulement une constante ? Pourquoi faire ?
...
%HUG: quelle conjonction de prédicat ? C'est quoi le rapport avec ce que tu as fait précédemment ?
...
%HUG: très bien mais pourquoi ? Justifier ?
  
  \medbreak

%HUG: cette partie est super !

...
{\large \textit{Résumé :}
  Le calcul du pire temps d'exécution ou WCET (Worst Case Execution Time)
  est un composant clé de la vérification des systèmes temps-réel critiques.
  ...
  infaisable: le chemin du WCET est bien un majorant mais
  ...
  forme utilisée pour le calcul du WCET et la plus proche
  de l'exécution réelle. La liste des chemins est énumérée
  et les états et conditions du programme sont représentés par un
  ensemble de prédicats: dès que cet ensemble n'est plus être satisfiable,

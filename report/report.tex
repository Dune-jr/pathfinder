...
%HUG: il faudrait donner la grammaire abstraite des prédicats ici ! Et l'expliquer. Un début ci-dessous en ASCII
%       Prédicat: Expression x Comparator x Expression
%        Comparator: EQ | NE | GT | GE | LT | LE
%       Expression: Const(k: \N)
%               |   Var(id: Registre)
%               |   Neg(Expression)
...
%TOLDO: parler des conjonctions de prédicats avant
 ...
 % 3e partie trad contraintes ilp
  ...
  % TODO: parler des contraintes IPET et de la loi des noeuds
...
\begin{thebibliography}{1}
    ...
    \bibitem{wcet05} T. Chen, T. Mitra, A. Roychoudhury, and V. Suhendra. Exploiting branch constraints without exhaustive path enumeration. In Int’l Workshop on WCET Analysis, 2005.

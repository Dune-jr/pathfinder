...
-- OTAWA
settings.cc.flags:Add("`/home/ruiz/Documents/casse/linux-x86_64/otawa-core/bin/otawa-config --cflags`")
settings.link.flags:Add("`/home/ruiz/Documents/casse/linux-x86_64/otawa-core/bin/otawa-config --libs --rpath`")

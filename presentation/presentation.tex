...
\frame{\frametitle{Recherche de chemins infaisables}
	\begin{columns}
		...
		\begin{column}{.63\textwidth}
			\alt<1>{
			    \makebox[\textheight]{\includegraphics[height=220px]{pictures/cfg.png}}
			}{
			    \makebox[\textheight]{\includegraphics[height=220px]{pictures/cfg_infeasible.png}}
			}
		\end{column}
	\end{columns}
}
...
%\frame{\frametitle{Instructions sémantiques}
%      \begin{lstlisting}
% .
% int x = 0;
%      \end{lstlisting}
...
\section{Représentation des prédicats}
\frame{\frametitle{Représentation des prédicats}
    
}


\section{Sujet de thèse proposé}
\frame{\frametitle{État des travaux}
	\begin{center}
		\includegraphics[height=0.7\paperheight]{pictures/pathfinder3.png}
	\end{center}
}
...
\frame{
	\begin{textblock*}{\textwidth}(0cm,-2cm)
		\begin{itemize}
			\item Thèse dans la continuation du stage M2R
			\item Problème difficile, très restreint pour le stage. Beaucoup d'extensions à faire :
			\begin{itemize}
